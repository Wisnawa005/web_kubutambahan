				...
				<div class="col-lg-4 col-md-6">
					<div class="single_place">
						<div class="thumb">
							...
							<a href="<?= ('user_login/detail_wisata/' . $wis->id_wisata) ?>" class="prise">Rp. <?php echo number_format($wis->harga, 0, ',', '.')  ?></a>
						</div>
						<div class="place_info">
							<a href="<?= ('user_login/detail_wisata/' . $wis->id_wisata) ?>">
							...
							<div class="rating_days d-flex justify-content-between">
								<span class="d-flex justify-content-center align-items-center">
									...
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<a href="<?= ('user_login/detail_wisata/' . $wis->id_wisata) ?>">(20 Review)</a>
								</span>
								<div class="days">
									<i class="fa fa-clock-o"></i>
									<a href="<?= ('user_login/detail_wisata/' . $wis->id_wisata) ?>"><?php echo $wis->durasi ?></a>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="more_place_btn text-center">
					<a class="boxed-btn4" href="<?= ('user_login/destination') ?>">More Places</a>
				</div>
			</div>
		</div>
	</div>
