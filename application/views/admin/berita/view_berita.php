			...
			<div class="col-lg-12">
				<div class="content-panel">
					<div class="chat-room-head">
						<a href="<?= base_url('admin/create_news') ?>">
									...
									<tr>
										...
										<td>
											<div class="hidden-phone">
												<a href="<?php echo base_url() . 'admin/perView_berita/' . $val['id_berita']; ?>">
													<button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
												</a>
												<a href="<?php echo base_url() . 'admin/edit_berita/' . $val['id_berita']; ?>">
													<button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
												</a>
												<a href="<?php echo base_url() . 'admin/delete_berita/' . $val['id_berita']; ?>">
