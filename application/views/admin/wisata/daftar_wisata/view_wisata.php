						...
						<table class="table table-bordered table-striped table-condensed">
							<thead>
								<tr>
									...
									<th>Desa</th>
									<th>Harga Tunjangan Paket</th>
									<th>Action</th>
								</tr>
							</thead>
							<tbody>
								<?php foreach ($dataWisata as $val) : ?>
									<tr>
										<td><?= ++$start ?></td>
										<td><?= $val['nama_wisata']; ?></td>
										<td><?= $val['nama_kategori']; ?></td>
										<td><?= $val['nama_desa']; ?> </td>
										<td><?= $val['harga']; ?> / <?= $val['durasi']; ?></td>
										<td>
											<div class="hidden-phone">
												<a href="<?php echo base_url() . 'admin/perView_wisata/' . $val['id_wisata']; ?>">
													<button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
												</a>
												<a href="<?php echo base_url() . 'admin/edit_wisata/' . $val['id_wisata']; ?>">
													<button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
												</a>
												<a href="<?php echo base_url() . 'admin/delete_wisata/' . $val['id_wisata']; ?>">
