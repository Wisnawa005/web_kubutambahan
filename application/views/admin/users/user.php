									...
									<tr>
										...
										<td>
											<div class="hidden-phone">
												<a href="<?php echo base_url() . 'admin/perView_users/' . $val['id_user']; ?>">
													<button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
												</a>
												<a href="<?php echo base_url() . 'admin/edit_users/' . $val['id_user']; ?>">
													<button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
												</a>
												<a href="<?php echo base_url() . 'admin/delete_users/' . $val['id_user']; ?>">
