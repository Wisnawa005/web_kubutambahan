				...
				<div class="content-panel">
					...
					<section id="unseen">
						<table class="table table-bordered table-striped table-condensed">
							...
							<tbody>
								<?php foreach ($pengelolawisata as $val) : ?>
									<tr>
										<td><?= ++$start ?></td>
										<td><?= $val['nama_pengelola']; ?></td>
										<td><?= $val['kontak_pengelola']; ?></td>
										<td><?= $val['jabatan_pengelola']; ?> </td>
										<td><?= $val['motto']; ?></td>
										<td><?= $val['foto_pengelola']; ?></td>
										<td>
											<div class="hidden-phone">
												<a href="<?php echo base_url() . 'admin/perView_pengelola/' . $val['id_pengelola']; ?>">
													<button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
												</a>
												<a href="<?php echo base_url() . 'admin/edit_pengelola/' . $val['id_pengelola']; ?>">
													<button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
												</a>
												<a href="<?php echo base_url() . 'admin/delete_pengelola/' . $val['id_pengelola']; ?>">
